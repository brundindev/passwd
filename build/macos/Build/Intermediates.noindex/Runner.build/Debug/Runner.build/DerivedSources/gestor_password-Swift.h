...
#ifndef GESTOR_PASSWORD_SWIFT_H
#define GESTOR_PASSWORD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="gestor_password",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15gestor_password11AppDelegate")
...
SWIFT_CLASS("_TtC15gestor_password17MainFlutterWindow")
